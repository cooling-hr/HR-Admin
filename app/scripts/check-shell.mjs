...
// Tailwind يُولَّد وقت البناء منذ المرحلة 4 ويُضمَّن في الملف؛ المكتبات الثقيلة (Excel/Word) وحدها
// تبقى من CDN (تُحمَّل عند الحاجة)، فلا يُفحَص «صفر مراجع خارجية» هنا.
